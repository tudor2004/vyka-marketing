...
OUT = R / "out"; WORK = R / "out/work"; WORK.mkdir(parents=True, exist_ok=True); TMP = R / "_cb"; TMP.mkdir(exist_ok=True)
FF = imageio_ffmpeg.get_ffmpeg_exe()
W, H, FPS = 1080, 1920, 30
SEGS = [("img", WORK / "c_hook.png", 4.0),
        ("img", WORK / "c_phone.png", 3.2),
        ("vid", WORK / "ee_veo_9x16.mp4", 5.5),
        ("img", OUT / "ee_shop_9x16.png", 3.5),
        ("img", WORK / "c_cta.png", 2.2),
