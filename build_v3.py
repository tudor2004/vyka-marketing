...
OUT = R / "out"; TMP = R / "_v3b"; TMP.mkdir(exist_ok=True)
FF = imageio_ffmpeg.get_ffmpeg_exe()
W, H, FPS = 1080, 1920, 30
M = 1.4
SEGS = [("vid", OUT / "a3v3_phone.mp4", 5.30),
        ("vid", OUT / "a3_step.mp4", 4.5),
        ("img", OUT / "a3_p1.png", M), ("img", OUT / "a3_p2.png", M),
        ("img", OUT / "a3_p3.png", M), ("img", OUT / "a3_p4.png", M),
        ("img", OUT / "a3_cta.png", 2.5),
